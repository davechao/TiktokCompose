...
import com.example.myapplication.datasource.data.UserData.charliePuth
import com.example.myapplication.datasource.data.UserData.daniel
import com.example.myapplication.datasource.data.UserData.duaLipa
import com.example.myapplication.datasource.data.UserData.google
import com.example.myapplication.datasource.data.UserData.imagineDragons
import com.example.myapplication.datasource.data.UserData.jeremy
import com.example.myapplication.datasource.data.UserData.kylieJenner
import com.example.myapplication.datasource.data.UserData.shana
import com.example.myapplication.datasource.data.UserData.taylor
import com.example.myapplication.datasource.data.UserData.zoya
import com.example.myapplication.model.VideoItem

object VideoData {

    object KylieJennerVideos {
        val kylie_vid1 = VideoItem(
            videoId = "kylie_vid1",
            authorDetails = kylieJenner,
            videoLink = "kylie_vid1.mp4",
            videoStats = VideoItem.VideoStats(
                like = 409876,
                comment = 8356,
                share = 3000,
                favourite = 1500
    ...
    object CharliePuthVideos {
        val charlieputh_vid1 = VideoItem(
        ...
        val charlieputh_vid2 = VideoItem(
        ...
        val charlieputh_vid3 = VideoItem(
    ...
    object ImagineDragonsVideos {
        val imaginedragons_vid1 = VideoItem(
        ...
        val imaginedragons_vid2 = VideoItem(
    ...
    object JeremyVideos {
        ...
        val jeremeyVideosList = arrayListOf(jeremy_vid1, jeremy_vid2, jeremy_vid3, jeremy_vid4)
    }

    object DanielVideos {
        val daniel_vid1 = VideoItem(
            videoId = "daniel_vid1",
    ...
    val videosList = arrayListOf<VideoItem>().apply {
