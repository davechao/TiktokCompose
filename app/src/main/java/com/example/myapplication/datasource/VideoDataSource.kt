...
import com.example.myapplication.datasource.UsersDataSource.charliePuth
import com.example.myapplication.datasource.UsersDataSource.daniel
import com.example.myapplication.datasource.UsersDataSource.duaLipa
import com.example.myapplication.datasource.UsersDataSource.google
import com.example.myapplication.datasource.UsersDataSource.imagineDragons
import com.example.myapplication.datasource.UsersDataSource.jeremy
import com.example.myapplication.datasource.UsersDataSource.kylieJenner
...
object VideoDataSource {
    ...
    object ZoyaVideos {
        ...
        val zoyaVideosList = arrayListOf(zoya_vid1, zoya_vid2, zoya_vid3, zoya_vid4, zoya_vid5, zoya_vid6)
    }
    ...
    fun fetchVideosOfParticularUser(userId: Long): Flow<List<VideoItem>> {
        return flow {
